...
int btree_max(int a, int b){ return a > b ? a : b; }
int btree_size(BTree** t){ return *t ? btree_size((*t)->l) + btree_size((*t)->r) : 0; }
int btree_depth(BTree** t){ return *t ? btree_max(btree_depth((*t)->l), btree_depth((*t)->r)) + 1 : 0; }
